...
import percentage from 'utils/maths'
...
interface IChakraCarouselProps {
  children: React.ReactNode[]
  gap: number
}

const ChakraCarousel: React.FC<IChakraCarouselProps> = ({ children, gap }) => {
...
const Item = ({
  ...
  const handleKeyDown = (event: KeyboardEvent) => event.key === 'Tab' && setUserDidTab(true)
